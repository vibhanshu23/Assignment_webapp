...
public class ViewOrder extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		 ...
		 * will be directed to this same servlet and user has given order number then
		 * this page shows all the order details
		 */
...
// }		
		...
		if (strOrder != null && strOrder.equals("CancelOrder")) {
			...
			if (request.getParameter("orderName") != null) {
				System.out.println("Reached Here do get if 1");
				...
				try {
					...
					System.out.println("Reached Here do get exception 1");
		...
		System.out.println("Reached Here do get last");
		...
		if(user1.getUsertype().equals("salesman") && (strOrder != null && strOrder.equals("Chicago"))){
			...
			// if ((strOrder != null && strOrder.equals("Chicago")) && user.getUsertype().equals("salesman")) {
				...
				try {
					...
					System.out.println("exception aaya" + e.getLocalizedMessage() + e.getMessage());
				...
				System.out.println(orderPayments);
				for (Map.Entry<Integer, ArrayList<OrderPayment>> od : orderPayments.entrySet()) {
					System.out.println("doPost Integer and ArrayLists" + od.getKey() + "sdasdadas " + od.getValue());
					for (OrderPayment orderItem : od.getValue()) {
						System.out.println("doPost Order List and ArrayLists" + orderItem.getOrderName());
						size = size + 1;
						// if (size>0) break;
					}
					// size= orderPayments.get(orderId).size();
			...
			System.out.println("Reached Here after 6");
